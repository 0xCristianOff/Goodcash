# Support for Output Descriptors in Goodcash Core

Since Goodcash Core v0.17, there is support for Output Descriptors in the
...
on Goodcash's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Goodcash Core wallets, a convenience function `combo` is
