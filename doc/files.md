...
* goodcash.conf: contains configuration settings for goodcashd or goodcash-qt
* goodcashd.pid: stores the process id of goodcashd while running
...
* debug.log: contains debug information and general logging generated by goodcashd or goodcash-qt
