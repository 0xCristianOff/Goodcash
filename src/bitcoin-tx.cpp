...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " goodcash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  goodcash-tx [options] <hex-tx> [commands]  Update hex-encoded goodcash transaction\n" +
            "or:     goodcash-tx [options] -create [commands]   Create hex-encoded goodcash transaction\n" +
            "\n";
