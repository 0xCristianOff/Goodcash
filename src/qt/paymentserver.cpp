...
const QString BITCOIN_IPC_PREFIX("goodcash:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/goodcash-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/goodcash-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/goodcash-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start goodcash: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("goodcash://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'goodcash://' is not a valid URI. Use 'goodcash:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Goodcash address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
