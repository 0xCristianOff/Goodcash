...
const char * const BITCOIN_CONF_FILENAME = "goodcash.conf";
const char * const BITCOIN_PID_FILENAME = "goodcash.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Goodcash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Goodcash";
#else
    // Unix
    return pathRet / ".goodcash";
#endif
#endif
}
