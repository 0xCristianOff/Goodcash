...
"""Verify that starting goodcash with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start goodcash with -h for help text")
        ...
        self.log.info("Start goodcash with -version for version information")
        ...
        self.log.info("Start goodcashd with -fakearg to make sure it does not start")
